...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('✪ ♻️ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ♻️', url="https://t.me/ModringMovies"),
                    InlineKeyboardButton('⌬ 🤍ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🤍', url="https://t.me/ModringMovies")
                ],[
                    InlineKeyboardButton('✇ Jᴏɪɴ Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ ✇', url="https://t.me/ModRingr")
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('🦋 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 🦋', url="https://t.me/Modringmovies_x"),
                    InlineKeyboardButton('✨ Mᴏᴠɪᴇ Gʀᴏᴜᴘ ✨', url="https://t.me/ModringMovies")
                ],[
            ...
            try:
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('♻️ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ♻️', url=f'https://t.me/{SUPPORT_CHAT}'),
                                InlineKeyboardButton('🤍ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ🤍', url="https://t.me/Modringmovies_x")
                            ],[
                                InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url="https://t.me/Modder_01")
                            ],
                            [
                                InlineKeyboardButton('🚀 𝙵𝚊𝚜𝚝 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 / 𝚆𝚊𝚝𝚌𝚑 𝙾𝚗𝚕𝚒𝚗𝚎🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥", url="t.me/Modder_01")
                         ],[ 
                            InlineKeyboardButton('🚀 𝙵𝚊𝚜𝚝 𝙳𝚘𝚠𝚗𝚕𝚘𝚊𝚍 / 𝚆𝚊𝚝𝚌𝚑 𝙾𝚗𝚕𝚒𝚗𝚎🖥️', callback_data=f'generate_stream_link:{file_id}') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
    ...
    if not files_:
        ...
        try:
            ...
            title = '@Modringr  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
    ...
    files = files_[0]
    title = '@Modringr  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))
    ...
    if CUSTOM_FILE_CAPTION:
        try:
            ...
            f_caption=f_caption
    if f_caption is None:
        f_caption = f"@Modringr  {' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), files.file_name.split()))}"
    if not await check_verification(client, message.from_user.id) and VERIFY == True:
        btn = [[
            InlineKeyboardButton("Verify", url=await get_token(client, message.from_user.id, f"https://telegram.me/{temp.U_NAME}?start="))
        ]]
