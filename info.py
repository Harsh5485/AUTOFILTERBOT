...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Harsh8963:Nokia213@cluster0.fr4mphl.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://{https://modringmovies-f5ac86bb8c08.herokuapp.com/}/".format('FQDN') if ON_HEROKU or NO_PORT else \
    "https://{https://modringmovies-f5ac86bb8c08.herokuapp.com/}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://{https://modringmovies-f5ac86bb8c08.herokuapp.com/}/".format(FQDN)
else:
    URL = "https://{https://modringmovies-f5ac86bb8c08.herokuapp.com/}/".format(FQDN)
